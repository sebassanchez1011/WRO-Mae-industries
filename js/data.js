const VOCES = {
  ...
  photos: {
    bribri: {
      coords: [9.62, -82.85],
      images: [
        { url: 'assets/images/talamanca1.jpg', caption: 'El rover-7 ascendió los senderos de Talamanca hasta las comunidades bribris enclavadas en la montaña. Casas de madera con techos de lámina se aferran a las laderas verdes, custodiadas por la selva que se extiende hasta el horizonte.', location: 'Comunidad Bribri, Alta Talamanca' },
        { url: 'assets/images/talamanca2.jpg', caption: 'Puente colgante de tablones y mallas que cruza el dosel de la selva. Una torre de concreto y escalera empinada se alza entre la vegetación densa, sendero de exploración hacia el corazón de Talamanca.', location: 'Sendero ecológico, Talamanca' },
        { url: 'assets/images/talamanca3.jpg', caption: 'Vivienda tradicional bribri elevada sobre pilotes de madera, con techo de palma seca y lona protectora. A sus pies, las gallinas picotean entre la tierra mientras las hojas de plátano y banano mecen el hogar ancestral.', location: 'Aldea tradicional, Reserva Bribri' }
      ]
    },
    cabecar: {
      coords: [9.58, -83.35],
      images: [
        { url: 'assets/images/talamanca4.jpg', caption: 'El rover-7 aún no ha llegado a las zonas más profundas del territorio cabécar. El Chirripó guarda secretos que solo serán revelados cuando el explorador logre ascender las empinadas laderas de la Alta Talamanca. Pronto, sus ruedas rodarán donde el jaguar aún camina.', location: 'Próxima expedición: Chirripó' }
      ]
    },
    ngabe: {
      coords: [8.98, -83.05],
      images: [
        { url: 'assets/images/talamanca4.jpg', caption: 'El Pacífico Sur aguarda al rover-7. Los territorios ngäbes, entre montañas y costa, serán explorados en la próxima misión. Los ríos caudalosos, el bosque tropical seco y los amaneceres del sur esperan ser documentados.', location: 'Próxima expedición: Coto Brus' }
      ]
    },
    maleku: {
      coords: [10.67, -84.82],
      images: [
        { url: 'assets/images/talamanca4.jpg', caption: 'Las llanuras del norte aún no han sido pisadas por el rover-7. Los humedales, la laguna donde habitan los espíritus y la ceiba sagrada maleku esperan al explorador. La expedición partirá pronto hacia Guatuso.', location: 'Próxima expedición: Guatuso' }
      ]
    },
    boruca: {
      coords: [9.05, -83.32],
      images: [
        { url: 'assets/images/talamanca4.jpg', caption: 'El valle del Río Térraba y las máscaras del Juego de los Diablitos aguardan al rover-7. El pueblo boruca, guardianes del fuego y el tejido ancestral, recibirán al explorador en la próxima travesía por el Pacífico Sur.', location: 'Próxima expedición: Boruca' }
      ]
    },
    terraba: {
      coords: [9.07, -83.38],
      images: [
        { url: 'assets/images/talamanca4.jpg', caption: 'El rover-7 se prepara para cruzar el valle del Río Térraba. El pueblo térraba, el más pequeño de Costa Rica, mantiene vivas sus tradiciones orales. La próxima misión documentará su cultura antes de que el río se lleve sus historias.', location: 'Próxima expedición: Térraba' }
      ]
    },
    huetar: {
      coords: [9.93, -84.08],
      images: [
        { url: 'assets/images/talamanca4.jpg', caption: 'El Valle Central, cuna del antiguo reino huetar, será explorado en la próxima fase. Los petroglifos, la cerámica y los montículos ceremoniales aguardan al rover-7 entre las montañas que rodean el valle.', location: 'Próxima expedición: Valle Central' }
      ]
    }
  }
};
